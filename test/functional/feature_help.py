...
"""Verify that starting mgcd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mgcd with -h for help text")
        ...
        self.log.info("Start mgcd with -version for version information")
