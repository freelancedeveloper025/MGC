#!/usr/bin/env python3
# Copyright (c) 2015-2020 The Mgc Core developers
...
class BlockRewardReallocationTest(MgcTestFramework):
    def set_test_params(self):
        self.set_mgc_test_params(2, 1, fast_dip3_enforcement=True)
        self.set_mgc_dip8_activation(450)
