#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Mgc Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
from test_framework.mininode import *
from test_framework.test_framework import MgcTestFramework
...
class LLMQCoinbaseCommitmentsTest(MgcTestFramework):
    def set_test_params(self):
        self.set_mgc_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as MgcTestFramework doesn't support this atm)
