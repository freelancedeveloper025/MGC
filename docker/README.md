...
official/supported Docker Images found at https://hub.docker.com/r/mgcpay/mgcd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/mgcpay/mgcd-develop/ when changing the above text**