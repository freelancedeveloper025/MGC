Contributing to Mgc Core
============================

The Mgc Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mgcpay/mgc/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Mgc Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Mgc
Network Protocol consensus changes.

Whether a pull request is merged into Mgc Core rests with the project merge
...
Patches that change Mgc consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mgc consensus, it must have been
...
The review process is normally fairly responsive on the Mgc Core repository, however
...
The project leader is the release manager for each Mgc Core release.
