...
//! Interface for the src/evo part of a mgc node (mgcd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a mgc node (mgcd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a mgc node (mgcd process).
...
//! Top-level interface for a mgc node (mgcd process).
class Node
{
public:
    virtual ~Node() {}
