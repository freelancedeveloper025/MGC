...
/** Utility functions used by the Mgc Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "mgc:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load mgc specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a mgc specific theme is activated (light/dark).*/
    bool mgcThemeActive();
