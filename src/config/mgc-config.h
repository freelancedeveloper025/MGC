/* src/config/mgc-config.h.  Generated from mgc-config.h.in by configure.  */
/* src/config/mgc-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Mgc Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Mgc Core"
...
#define PACKAGE_BUGREPORT "https://github.com/mgcpay/mgc/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Mgc Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mgc Core 0.17.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mgccore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://mgc.org/"
