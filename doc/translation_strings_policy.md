...
This document provides guidelines for internationalization of the Mgc Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mgc_en.ts` remains unchanged.
