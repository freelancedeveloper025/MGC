...
* mgc.conf: contains configuration settings for mgcd or mgc-qt
* mgcd.pid: stores the process id of mgcd while running
...
* debug.log: contains debug information and general logging generated by mgcd or mgc-qt
