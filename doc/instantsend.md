...
This mechanism has been integrated into Bitcore-Node-Mgc which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mgcpay/insight-api-mgc#web-socket-api](https://github.com/mgcpay/insight-api-mgc#web-socket-api)
* API: [https://github.com/mgcpay/insight-api-mgc#instantsend-transactions](https://github.com/mgcpay/insight-api-mgc#instantsend-transactions)
